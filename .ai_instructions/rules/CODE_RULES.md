...
* **Версионирование статических файлов (Cache Busting)**: При редактировании любых JS или CSS файлов необходимо обязательно обновить (поднять) параметр версии `?v=...` в HTML/шаблонах в местах их подключения. Это гарантирует, что браузеры клиентов мгновенно получат обновленную версию файла без использования кэша.
