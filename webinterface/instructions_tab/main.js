...
async function previewPrompt() {
  ...
  const preview = `
    ...
    ${escapeHtml(content.substring(0, 500))}${content.length > 500 ? '...' : ''}<br><br>
...
async function initInstructionsTab() {
  ...
  console.log('Instructions tab initialized');
}
